...
for (const name of ['index.html', 'rule-registry-test.html', 'semantic-router-poc.html', 'semantic-router-poc-v02.html', 'semantic-router-poc-v03.html', 'semantic-router-poc-v04.html', 'semantic-router-poc-v05.html', 'README.md', 'vendor-versions.json', '.nojekyll']) {
