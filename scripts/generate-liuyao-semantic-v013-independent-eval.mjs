...
addKnown('strong_arbitration','inventory_sale',[
  '仓库里这批积压货下个月能不能卖完','门店剩下的旧库存年底前能不能卖掉'
]);
...
addKnown('support_arbitration','commercial_transaction',[
  '客户这份商业订单还在沟通中，我想占一下','这笔采购交易目前正在谈，我想看看这件事','供应商合同还在修改，我想单独问这一单','买家这份订单现在还没有定，我想占一下','这单批发订单目前还在磋商，我想看看'
]);
...
addKnown('support_arbitration','investment_position_decision',[
  '这只基金我在考虑加仓，想占一下这个调整','手里的股票正在犹豫要不要减仓，我想看看','ETF仓位要不要调整一下这件事我一直拿不准','当前基金持仓准备重新调整，我想单独占一下'
]);
