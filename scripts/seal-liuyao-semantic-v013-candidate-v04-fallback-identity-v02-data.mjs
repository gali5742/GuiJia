...
const schemaPath = 'data/liuyao-semantic-v013-candidate-v04-fallback-identity-v02-data-schema-v0.1.json';
...
const lock = {
  version:'0.13-candidate-v0.4-fallback-identity-v0.2-data-lock-v0.1',
  status:'locked',
...
console.log('Candidate v0.4 Fallback Identity v0.2 training/calibration corpora sealed together.');
