...
addKnown('strong_arbitration','item_purchase',[
  '这台投影仪现在值不值得买','我现在要不要买这副耳机','这款扫地机器人买回家合不合适'
]);
...
addKnown('support_arbitration','business_operation',[
  '我的店最近利润起伏很大，想占一下经营这件事','工作室这阵子经营状况不太稳定，我想问问','这家门店目前营业情况反复，我想占这一块','我做的生意最近一直在亏损和回升之间波动','这个摊位现在经营状况让我很在意，想看看','网店最近业绩变化很大，我想问经营本身','餐馆目前利润不稳定，我想单独占这件事','公司这项业务最近现金流反复，我想看看'
]);
addKnown('support_arbitration','investment_profit',[
  '我主要在意这笔投资的收益波动，想占一下','这只基金现在有收益变化，我想看看这件事','这项投资目前利润起伏很大，我想问这一块','我投的项目最近收益反复，想单独占这件事','手里的基金目前有些利润波动，我想看看','这笔投资最近回本情况反复，我想问问','这个投资标的目前收益变化让我很在意'
]);
addKnown('support_arbitration','investment_liquidation',[
  '我已经决定把这只基金全部赎回，想占这一件事','手里的股票准备一次性清仓，我想看看这件事','这笔投资正在安排全部变现，我想单独占一下','我准备退出这项投资，想问问这个动作本身','这只ETF已经计划全部卖出，我想看看','基金仓位准备清掉，我想占一下这一步','这笔持仓已经决定平仓，我想问这件事'
]);
...
addKnown('fallback_head','borrow_money',['我能不能从家里先拿到一笔周转钱','最近有没有人愿意先给我一笔钱周转']);
