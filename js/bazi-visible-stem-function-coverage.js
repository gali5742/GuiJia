(function (global) {
    ...
    if (typeof document !== 'undefined' && document.readyState === 'loading' && !GuiJia.baziVisibleStemFunctionRealization) {
        document.write('<script src="./js/bazi-visible-stem-function-realization.js?v=13.44.0"><\/script>');
    }
