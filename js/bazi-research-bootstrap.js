(function (global) {
    ...
    const dependencies = Object.freeze([
        ...
        Object.freeze({ globalKey:'baziContextualForcePartyRelationTargetNormalizedInputContract', src:'./js/bazi-contextual-force-party-relation-target-normalized-input-contract.js?v=13.44.0' }),
        Object.freeze({ globalKey:'baziContextualForcePartyRelationTargetNormalizedInputProfile', src:'./js/bazi-contextual-force-party-relation-target-normalized-input-profile.js?v=13.44.0' }),
        Object.freeze({ globalKey:'baziContextualForcePartyRelationTargetNormalizedInput', src:'./js/bazi-contextual-force-party-relation-target-normalized-input.js?v=13.44.0' }),
        Object.freeze({ globalKey:'baziContextualForcePartyGenericTargetLevelResolverContract', src:'./js/bazi-contextual-force-party-generic-target-level-resolver-contract.js?v=13.44.0' }),
        Object.freeze({ globalKey:'baziContextualForcePartyGenericTargetLevelResolverProfile', src:'./js/bazi-contextual-force-party-generic-target-level-resolver-profile.js?v=13.44.0' }),
        Object.freeze({ globalKey:'baziContextualForcePartyGenericTargetLevelResolver', src:'./js/bazi-contextual-force-party-generic-target-level-resolver.js?v=13.44.0' }),
        ...
        Object.freeze({ globalKey:'baziContextualForcePartyRelationEndpointIdentityContract', src:'./js/bazi-contextual-force-party-relation-endpoint-identity-contract.js?v=13.44.0' }),
        Object.freeze({ globalKey:'baziContextualForcePartyRelationEndpointIdentityProfile', src:'./js/bazi-contextual-force-party-relation-endpoint-identity-profile.js?v=13.44.0' }),
        Object.freeze({ globalKey:'baziContextualForcePartyRelationEndpointIdentity', src:'./js/bazi-contextual-force-party-relation-endpoint-identity.js?v=13.44.0' }),
        Object.freeze({ globalKey:'baziContextualForcePartyGenericRelationEffectExecutionContract', src:'./js/bazi-contextual-force-party-generic-relation-effect-execution-contract.js?v=13.44.0' }),
        Object.freeze({ globalKey:'baziContextualForcePartyGenericRelationEffectExecutionProfile', src:'./js/bazi-contextual-force-party-generic-relation-effect-execution-profile.js?v=13.44.0' }),
        Object.freeze({ globalKey:'baziContextualForcePartyGenericRelationEffectExecution', src:'./js/bazi-contextual-force-party-generic-relation-effect-execution.js?v=13.44.0' }),
