(function (global) {
    ...
    if (!assessmentApi?.bindAssessmentForComparison) {
        throw new Error('liuyao-domain-assessment-pretraining-v01.js must be loaded before liuyao-travel-execution-comparator-pretraining-v01.js');
    }
    if (!comparatorApi?.validateDimensionAssessment) {
        throw new Error('liuyao-domain-comparator-pretraining-v01.js must be loaded before liuyao-travel-execution-comparator-pretraining-v01.js');
    }

    const VERSION = '0.1';
    const STATUS = 'isolated_candidate_not_registered';
    const COMPARATOR_REF = 'CP-TV-EXEC-001';
    ...
    const ASSESSMENT_REF = 'travel_execution_assessment_v0.1';
    ...
    GuiJia.liuyaoTravelExecutionComparatorPretrainingV01 = Object.freeze({
        version:VERSION,
        status:STATUS,
        comparatorRef:COMPARATOR_REF,
        currentRuntimeReachable:false,
