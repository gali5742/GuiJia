(function (global) {
    ...
    const contributionInventory = (synthesis = {}) => {
        ...
        return Object.freeze({
            ...
            realizedRestraintContributionIds:byMeaning('restraint'),
            realizedDrainContributionIds:byMeaning('drain'),
            realizedDistributionContributionIds:byMeaning('distribution'),
            restraintDrainContributionIds:freezeArray(unique([
                ...byMeaning('restraint'),
                ...byMeaning('drain')
            ])),
